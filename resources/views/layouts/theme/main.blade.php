...
<html lang="en">
<head>
    @include('layouts.theme.parts.head')
</head>
<body>
    <header>
        ...
        <div class="navbar navbar-light py-lg-4 pt-3 px-0 pb-0">
            <div class="container">
                ...
                <div class="col-xxl-2 col-lg-3">
                    ...
                    <h1 class="mb-1">J&P online</h1><h1 class='mb-1'>la Carne</h1>
                    </a>
        ...
        <div class="container px-0 px-md-3">
            ...
            <div class="dropdown me-3 d-none d-lg-block">
                <form method='POST'>
                    ...
                    <button class="btn btn-primary px-6 " type="submit" formaction="{{route('order.store')}}">
                        <span class="me-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                ...
                <ul class="navbar-nav ">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="{{ route('store.show', $item) }}">{{$item->name}}</a></li>
                            @endforeach
                        </ul>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="{{ route('password.request') }}">Forgot Password</a></li>
                            @endguest
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
      <div class="offcanvas-header border-bottom">
        <div class="text-start">
          ...
          <small>Location in 382480p</small>
        </div>
