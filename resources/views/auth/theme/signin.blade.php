        ...
        <div class="col-12 col-md-6 offset-lg-1 col-lg-4 order-lg-2 order-1">
          ...
          <form method='POST' action="{{ route('login') }}">
            ...
            <div class="row g-3">
              ...
              <!-- btn -->
              <div class="col-12 d-grid"> <input type="submit" class="btn btn-primary" value="Sign In">
              </div>
              <!-- link -->
              <div>Don’t have an account? <a href="{{route('register')}}"> Sign Up</a></div><!--a href="../pages/signup.html"-->
            </div>
          </form>
        </div>
      </div>
