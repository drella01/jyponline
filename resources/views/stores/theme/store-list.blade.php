  ...
  @section('content')
    ...
    <main>
        ...
        <section class="mt-6 mb-lg-14 mb-8">
            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="mb-4">
                        <!-- title -->
                        <h6>We have <span class="text-primary">{{ $stores->count()}}</span> vendors now</h6>
                    </div>
                    </div>
                </div>
                <!-- row -->
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 g-lg-4">
                    ...
                    <div class="col">
                        ...
                        <div class="card flex-row p-8 card-product ">
                            <div>
                                <!-- img -->
                                <img src="../assets/images/products/product-img-13.jpg" alt=""
                                    class="rounded-circle icon-shape icon-xl">
                            </div>
                            <!-- content -->
                            <div class="ms-6">
                            <h5 class="mb-1"><a href="{{ route('store.show', $item) }}" class="text-inherit">{{ $item->name }}</a></h5>
                    ...
                    <div class="col" hidden>
                        ...
                        <div class="card flex-row p-8 card-product ">
                            ...
                            <!-- content -->
                            <div class="ms-6">
                            <h5 class="mb-1"><a href="#!" class="text-inherit">{{ $item->name }}</a></h5>
                            <div class="small text-muted">
                                <span>Organic</span>
                                <span class="mx-1"><svg xmlns="http://www.w3.org/2000/svg" width="4" height="4" fill="#C1C7C6"
                                    class="bi bi-circle-fill align-middle " viewBox="0 0 16 16">
        ...
        <section class="mb-lg-14 mb-8" hidden>
            <div class="container">
            <div class="row">
                <div class="col-12">
                <div class="mb-6">
